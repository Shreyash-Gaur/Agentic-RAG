...
FAISS_INDEX_PATH = "backend/db/vector_data/data_faiss.index"
META_JSONL_PATH = "backend/db/vector_data/data_meta.jsonl"
META_DB_PATH = "backend/db/vector_data/metadata_store.db" 
CACHE_DB_PATH = "backend/db/emb_cache/embed_cache.sqlite"
